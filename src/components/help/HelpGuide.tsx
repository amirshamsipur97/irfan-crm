...
const DICT: Record<Lang, Dict> = {
  fa: {
    ...
    roles: [
      ...
      ["Agent", "فقط لیدهای خودش را می‌بیند و روی همان‌ها کار می‌کند"],
  ...
  en: {
    ...
    roles: [
      ...
      ["Agent", "Sees and works only their own leads"],
  ...
  ru: {
    ...
    roles: [
      ...
      ["Agent", "Видит только свои лиды и работает только с ними"],
